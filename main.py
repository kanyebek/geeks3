...
def main(page: ft.Page):
    ...
    filter_button = ft.Row([
        ...
        ft.ElevatedButton("Выполненные", on_click=lambda e: set_filter("completed"),icon=ft.icons.CHECK),
        ft.ElevatedButton("Удалить выполненные", on_click=lambda e: delete_completed_tasks(), icon=ft.icons.DELETE),
        ft.ElevatedButton("Невыполненные", on_click=lambda e: set_filter("incomplete"), icon=ft.icons.CHECK_BOX_OUTLINE_BLANK)
